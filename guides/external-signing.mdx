...
description: How to sign transactions with your quantum-safe key — the core integration point.
---
...
The signing operation takes the 32-byte hash digest as input and produces a Dilithium3 signature (3,293 bytes). Use the SDK or tooling provided during onboarding for your specific key management setup.
