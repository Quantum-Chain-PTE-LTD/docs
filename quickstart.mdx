...
Register an external Quantum Chain wallet address. The custody API does not generate keys — you provide the public key and address from your external signer.
