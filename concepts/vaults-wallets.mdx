...
Since the Custody API is non-custodial, you **register** existing wallets rather than having the API generate keys. You provide the address and post-quantum public key from your external key management system.
